...
namespace Ucu.Poo.RolePlayGame
{
    public abstract class Personaje
    {
        ...
        public void AgregarItem(Item item)
        {
            ...
            // Cambiado a la interfaz IItemMagico
            if (item is IItemMagico && !this.PuedeUsarItemsMagicos)
            {
                throw new InvalidOperationException($"{this.nombre} no puede usar ítems mágicos.");
            }
